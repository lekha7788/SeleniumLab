...
public class D10MotorCycle_Gold {
	public static void main(String[] args) throws InterruptedException {
		...
		//Price Option
		String expPrice="701.00",expClaim="Submit",expDis="2",expCover="Limited",actPrice,actClaim,actDis,actCover;
		...
		System.out.println("Checking Motor Cycle - Gold values");
