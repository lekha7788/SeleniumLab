...
public class D11MotorCycle_Platinum {
	public static void main(String[] args) throws InterruptedException {
		...
		//Price Option
		String expPrice="1,377.00",expClaim="Submit",expDis="5",expCover="Limited",actPrice,actClaim,actDis,actCover;
		...
		System.out.println("Checking Motor Cycle - Platinum values");
