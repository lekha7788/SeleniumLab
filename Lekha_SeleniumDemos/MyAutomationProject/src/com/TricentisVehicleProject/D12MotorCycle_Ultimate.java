...
public class D12MotorCycle_Ultimate {
	public static void main(String[] args) throws InterruptedException {
		...
		//Price Option
		String expPrice="2,623.00",expClaim="Submit",expDis="10",expCover="Unlimited",actPrice,actClaim,actDis,actCover;
		...
		System.out.println("Checking Motor Cycle - Ultimate values");
